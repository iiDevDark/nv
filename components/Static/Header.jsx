            ...
            <div className="relative w-full h-full">
                ...
                <div className="flex justify-between border-b border-white/20 items-center px-5 py-4">
                    <div className="flex items-center">
                        ...
                        <p className=" font-extrabold ml-1 text-2xl">Sagiri Bot</p>
                    </div>
...
const Header = ({ $, NavItems }) => {
    ...
    const colorsThemes = [
        { id: 'violet', color: 'violet', label: 'بنفسجي' },
        { id: 'blue', color: 'blue', label: 'سماوي' },
        { id: 'emerald', color: 'emerald', label: 'زمرد' },
        { id: 'rose', color: 'rose', label: 'وردي' },
        { id: 'amber', color: 'amber', label: 'كهرمان' },
    ];
                    ...
                    <div className="flex items-center space-x-6">
                        <div className="flex items-center space-x-3">
                            ...
                            <p className="invisible md:visible text-xl text-white font-semibold">
                              <a href="/"><span className="text-amber-400">Sagiri</span>Bot</a>
                            </p>
                        </div>
